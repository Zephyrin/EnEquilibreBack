 ...
 */
final class Version20210413201846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform()->getName() === 'pgsql') {
            ...
            $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, background_id, separator_id, contact, comment, email, phone FROM contact');
            $this->addSql('DROP TABLE contact');
            $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, background_id INTEGER DEFAULT NULL, separator_id INTEGER DEFAULT NULL, contact VARCHAR(1024) DEFAULT NULL COLLATE BINARY, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_4C62E638C93D69EA FOREIGN KEY (background_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4C62E638A480B5AC FOREIGN KEY (separator_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
            $this->addSql('INSERT INTO contact (id, background_id, separator_id, contact, comment, email, phone) SELECT id, background_id, separator_id, contact, comment, email, phone FROM __temp__contact');
            ...
            $this->addSql('CREATE TABLE ext_translations (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, locale VARCHAR(8) NOT NULL COLLATE BINARY, field VARCHAR(32) NOT NULL COLLATE BINARY, foreign_key VARCHAR(64) NOT NULL COLLATE BINARY, content CLOB DEFAULT NULL COLLATE BINARY, object_class VARCHAR(191) NOT NULL)');
            ...
            $this->addSql('CREATE TABLE gallery (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, main_id INTEGER DEFAULT NULL, separator_id INTEGER DEFAULT NULL, show_case_id INTEGER DEFAULT NULL, title VARCHAR(1024) DEFAULT NULL COLLATE BINARY, order_ INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_472B783A627EA78A FOREIGN KEY (main_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_472B783AA480B5AC FOREIGN KEY (separator_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_472B783AA842F916 FOREIGN KEY (show_case_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform()->getName() === 'pgsql') {
            ...
            $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, background_id, separator_id, contact, comment, email, phone FROM contact');
            $this->addSql('DROP TABLE contact');
            $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, background_id INTEGER DEFAULT NULL, separator_id INTEGER DEFAULT NULL, contact VARCHAR(1024) DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL)');
            $this->addSql('INSERT INTO contact (id, background_id, separator_id, contact, comment, email, phone) SELECT id, background_id, separator_id, contact, comment, email, phone FROM __temp__contact');
            $this->addSql('DROP TABLE __temp__contact');
            $this->addSql('CREATE INDEX IDX_4C62E638C93D69EA ON contact (background_id)');
            $this->addSql('CREATE INDEX IDX_4C62E638A480B5AC ON contact (separator_id)');
            ...
            $this->addSql('CREATE TEMPORARY TABLE __temp__ext_translations AS SELECT id, locale, object_class, field, foreign_key, content FROM ext_translations');
            $this->addSql('DROP TABLE ext_translations');
            $this->addSql('CREATE TABLE ext_translations (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, locale VARCHAR(8) NOT NULL, field VARCHAR(32) NOT NULL, foreign_key VARCHAR(64) NOT NULL, content CLOB DEFAULT NULL, object_class VARCHAR(255) NOT NULL COLLATE BINARY)');
            $this->addSql('INSERT INTO ext_translations (id, locale, object_class, field, foreign_key, content) SELECT id, locale, object_class, field, foreign_key, content FROM __temp__ext_translations');
            $this->addSql('DROP TABLE __temp__ext_translations');
            $this->addSql('CREATE INDEX translations_lookup_idx ON ext_translations (locale, object_class, foreign_key)');
            $this->addSql('CREATE UNIQUE INDEX lookup_unique_idx ON ext_translations (locale, object_class, field, foreign_key)');
