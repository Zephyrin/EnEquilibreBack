 ...
 */
final class Version20210711115512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($this->connection->getDatabasePlatform()->getName() === 'sqlite') {
            ...
            $this->addSql('CREATE TABLE gallery (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, main_id INTEGER DEFAULT NULL, separator_id INTEGER DEFAULT NULL, show_case_id INTEGER DEFAULT NULL, title VARCHAR(1024) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, order_ INTEGER NOT NULL)');
